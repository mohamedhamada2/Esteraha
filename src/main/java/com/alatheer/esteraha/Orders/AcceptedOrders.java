...
public class AcceptedOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView_order = findViewById(R.id.recycler_accepted_order);
        ...
        handleSideMenu();
        Api.getService().get_all_orders("1").enqueue(new Callback<OrdersModel>() {
            @Override
            public void onResponse(Call<OrdersModel> call, Response<OrdersModel> response) {
                if(response.isSuccessful()){
                    if(response.body().getSucess()== 1){
                        ...
                        orders_adapter = new Orders_Adapter(recordList,AcceptedOrders.this);
                        recyclerView_order.setAdapter(orders_adapter);
                        recyclerView_order.setHasFixedSize(true);
                        manager = new LinearLayoutManager(AcceptedOrders.this);
                        recyclerView_order.setLayoutManager(manager);
                        Toast.makeText(AcceptedOrders.this, "llll", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    private void handleSideMenu() {
        ...
        reservation_lyt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(AcceptedOrders.this, Resevation_Management_Home.class));
            }
        });
        ...
        client_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AcceptedOrders.this, Clients_Home.class));
            }
        });
        ...
        main_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AcceptedOrders.this, RestsManagementHome.class));
            }
        });
        ...
        reports_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AcceptedOrders.this, ReportsManagements.class));
            }
        });
        ...
        expenses_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AcceptedOrders.this, AddMasrof.class));
            }
        });
        ...
        fee_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AcceptedOrders.this, FeeHome.class));
            }
        });
        ...
        logout_lyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mprefs.ClearData(AcceptedOrders.this);
                startActivity(new Intent(AcceptedOrders.this, LoginActivity.class));
            }
        });
    }
